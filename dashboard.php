...
<html lang="pt-br">
  ...
  <body class="w3-white">
    ...
    <div class="h-100 w3-display-container w3-text-brown">
      <!-- Top container -->
      <div class="w3-bar w3-top w3-brown w3-large w3-text-sand" style="z-index:4">
      ...
      <!-- Sidebar/menu -->
      <nav style="display: none !important; position: relative !important;" class="w3-sidebar w3-bar-block w3-sand w3-animate-left" id="mySidebar"><br>
        <!-- Part 1 menu -->
        <div class="w3-container w3-row-padding w3-center w3-text-brown">
          <div class="w3-col s12 m12 l12 w3-bar mt-menu">
            <div class="w3-col s12 m12 l12 w3-leftbar w3-rightbar w3-border-brown w3-padding w3-margin-bottom">
        ...
        <div class="w3-bar-block w3-text-brown">
          <a href="dashboard.php" class="w3-bar-item w3-btn w3-hover-brown w3-padding w3-brown"><i class="fas fa-home"></i> Home</a>
          <a href="#" class="w3-bar-item w3-btn w3-hover-sand w3-hover-text-brown w3-padding"><i class="fa fa-users fa-fw"></i> Emails cadastrados</a>
          <a href="#" class="w3-bar-item w3-btn w3-hover-sand w3-hover-text-brown w3-padding"><i class="far fa-envelope"></i> Enviar email</a>
          <a href="#" class="w3-bar-item w3-btn w3-hover-sand w3-hover-text-brown w3-padding"><i class="fas fa-history"></i> Histórico de enviados</a>
          <!-- Bottom menu -->
          <div class="w3-display-bottommiddle w-100">
            <hr>
            <button type="button" class="w3-bar-item w3-button w3-brown w3-hover-sand w3-hover-text-brown w3-padding w3-center" onclick="w3_menu()"><i class="fas fa-times"></i> Fechar menu</button>
          </div>
        </div>
      </nav>
        ...
        <div class="w3-col w-100 w3-display-container">
          ...
          <div class="w3-row w3-content w3-middle mt-menu dash">
            <div class="w3-row w3-col s12 m12 l12">
              <button onmouseout="normal(this)" onmouseover="hover(this)" class="w3-col s12 m l6 w3-btn w3-card-2 card-buttons" disabled>
                  <h2 class="w3-brown"><i class="fas fa-home"></i></h2>
                  <h3>Home</h3>
              </button>

              <button onmouseout="normal(this)" onmouseover="hover(this)" class="w3-col s12 m l6 w3-btn w3-card-2 card-buttons ml">
                  <h2 class="w3-brown"><i class="fa fa-users fa-fw"></i></h2>
                  <h3>Emails Cadastrados</h3>
              </button>

              <button onmouseout="normal(this)" onmouseover="hover(this)" class="w3-col s12 m l6 w3-btn w3-card-2 card-buttons">
                  <h2 class="w3-brown"><i class="far fa-envelope"></i></h2>
                  <h3>Enviar email</h3>
              </button>

              <button onmouseout="normal(this)" onmouseover="hover(this)" class="w3-col s12 m l6 w3-btn w3-card-2 card-buttons ml">
                  <h2 class="w3-brown"><i class="fas fa-history"></i></h2>
                  <h3>Histórico de enviados</h3>
              </button>
            </div>
          </div>
        </div>
    ...
    <script>
      ...
      function normal(x) {
        var c = x.children;
        console.log(x.children);
        c[0].setAttribute("class", "w3-brown");
